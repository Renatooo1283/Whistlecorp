...
import { ScrollStorySection } from "@/components/blocks/ScrollStorySection";
import {
  hero,
  trustStrip,
  problems,
...
import type { ScrollStoryStep } from "@/components/blocks/ScrollStorySection";
...
export default function HomePage() {
  return (
    <>
      ...
      {/* ─── Scrollytelling: video controlado por scroll con steps ──── */}
      <ScrollStorySection
        src="/videos/whistlecorp-scroll-optimized.mp4"
        sectionHeight="520vh"
        steps={storySteps}
      />
