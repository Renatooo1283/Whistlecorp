...
export function ScrollStoryCanvas({
  ...
  return (
    ...
    >
      ...
      {/* Scroll hint, only on intro scene */}
      <div
        aria-hidden
...
function SceneOverlay({
  ...
  return (
    <div
      aria-hidden={!active}
      className={`pointer-events-none absolute inset-0 flex items-end justify-center p-5 transition-all duration-500 ease-out sm:p-8 lg:items-center lg:px-16 ${alignCls} ${
        active
    ...
    >
      <div
        className={`${active ? "pointer-events-auto" : ""} w-full max-w-md rounded-2xl border border-white/10 bg-black/45 p-5 backdrop-blur-md sm:p-6 lg:max-w-lg lg:border-0 lg:bg-transparent lg:p-0 lg:backdrop-blur-none ${textAlignCls}`}
      >
        {step.eyebrow && (
