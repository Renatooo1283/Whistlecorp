...
const inputClasses =
  "w-full rounded-lg border border-[var(--color-border)] bg-white px-3.5 py-2.5 text-sm text-[var(--color-text-strong)] placeholder:text-[var(--color-text)]/60 focus:border-[var(--color-accent)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)]/20 disabled:bg-[var(--color-bg-alt)] aria-[invalid=true]:border-red-500 aria-[invalid=true]:focus:ring-red-500/20";
