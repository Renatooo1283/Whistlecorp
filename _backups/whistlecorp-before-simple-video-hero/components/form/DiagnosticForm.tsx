...
export function DiagnosticForm() {
  ...
  return (
    <div className="rounded-2xl border border-[var(--color-border)] bg-white p-6 shadow-[0_12px_32px_rgba(11,27,43,0.06)] sm:p-8">
      ...
      <form onSubmit={onSubmit} noValidate className="space-y-4">
        ...
        <div className="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:items-center sm:justify-between">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full px-4 py-2.5 text-sm font-semibold text-[var(--color-text)] hover:text-[var(--color-ink)] disabled:invisible"
          >
