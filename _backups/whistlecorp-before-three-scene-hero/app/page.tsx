...
const storyScenes: ScrollStoryScene[] = [
  // Scene 0 — HERO principal (reemplaza el banner estático anterior)
  {
    frameProgress: 0.0,
    step: {
      variant: "hero",
    ...
    <>
      ...
      {/*
        ...
        - frames 1–40 son la "explosión" inicial (fragmentos verdes flotando)
          y se excluyen del recorrido para que el usuario nunca pueda detenerse
          en un estado incompleto.
        - frames 41–109 = 69 frames "limpios" usables.
        - lastSceneTransitionMs = 1100 → el logo final se ve por más tiempo.
      */}
      <ScrollStoryCanvas
